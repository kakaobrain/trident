...
@util.report("mean forward", ["x_size"], [128 * i for i in range(1, 21)], {"y_size": 32})
...
@util.report("mean backward", ["x_size"], [128 * i for i in range(1, 21)], {"y_size": 32})
def bench_mean_backward(y_size, x_size, backend):
