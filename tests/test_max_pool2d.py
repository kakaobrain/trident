...
def test_function(knl_sz, dtype):
    inp = torch.randn(2, 3, 128, 128, dtype=dtype, device='cuda')
...
def test_forward(knl_sz, dtype):
    inp = torch.randn(10, 7, 256, 256, dtype=dtype, device='cuda')
